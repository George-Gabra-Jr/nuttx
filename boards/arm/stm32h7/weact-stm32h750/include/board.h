...
/* SPI1 (8MB External SPI Flash W25Q64) - WeAct STM32H750 actual pinout */

#define GPIO_SPI1_SCK    (GPIO_SPI1_SCK_2  | GPIO_SPEED_50MHz) /* PB3 */
#define GPIO_SPI1_MISO   (GPIO_SPI1_MISO_2 | GPIO_SPEED_50MHz) /* PB4 */
